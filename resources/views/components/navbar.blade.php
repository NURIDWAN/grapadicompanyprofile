...
$navItems = [
    ...
    ['label' => 'Capital Connect', 'url' => route('matching.index'), 'active' => str_starts_with($currentRoute, 'capital-connect') || str_starts_with($currentRoute, 'capital') || str_starts_with($currentRoute, 'asset-matching')],
